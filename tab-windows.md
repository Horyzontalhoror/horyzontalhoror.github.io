...
- [Windows Install / Debloat Guide](https://wispydocs.pages.dev/windows/) - Windows guides
...
- [Privacy](https://privacy.sexy/) - Privacy script
...
- [Awesome Win11](https://github.com/awesome-windows11/windows11) - Windows 11 settings, tweaks, scripts
  - [Should I remove it](https://www.shouldiremoveit.com/index.aspx) - Guide to check and remove bloatware
...
- [G-helper](https://g-helper.com/) - Lightweight control tool for Asus
- [Windhawk](https://windhawk.net/) - Customize Windows
- [Macrocreator](https://www.macrocreator.com/download/) - Macro creator automation tool for Windows
- [Autohotkey](https://www.autohotkey.com/) - Scriptable automation tool for Windows
- [Windhawk](https://windhawk.net/) - Customize Windows
- [Macrocreator](https://www.macrocreator.com/download/) - Macro creator automation tool for Windows
- [Autohotkey](https://www.autohotkey.com/) - Scriptable automation tool for Windows
...
- [HelpWire](https://www.helpwire.app/) - Remote desktop software
...
- [WizTree](https://www.diskanalyzer.com/) - Disk space analyzer
  ...
  - [TreeSize](https://www.jam-software.com/treesize_free) - Disk space analyzer
- [CrystalDiskMark](https://crystalmark.info/en/software/crystaldiskmark/) - Disk benchmark tool
- [CrystalDiskInfo](https://crystalmark.info/en/software/crystaldiskinfo/) - Disk health checker
- [ValiDrive](https://www.grc.com/validrive.htm) - Drive health checker
- [Diskpart](https://www.diskpart.com/download.html) - Disk partitioning tool
